...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            ...
            description:
                'Ya está activada. Escaneá el código QR o cargá la clave a mano en tu app de autenticación.',
            buttonText: 'Cerrar',
        };
    }
    ...
    if (showVerificationStep.value) {
        return {
            ...
            description:
                'Ingresá los 6 dígitos que te muestra tu app de autenticación',
    ...
    return {
        ...
        description:
            'Escaneá el código QR con tu app de autenticación, o cargá la clave a mano',
        buttonText: 'Continuar',
    };
});
